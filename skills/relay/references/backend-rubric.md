...
The closed set is `claude`, `codex`, and `grok`. Every backend runs the same brief. What differs is launch-time enforcement, residual exposure, and the compensating controls.
